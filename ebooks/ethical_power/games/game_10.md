...
## Mechanics
1.  The Teacher starts their sermon.
2.  The Peer must interrupt gently using **Validation + Expert Contribution** or **Meta-comment** techniques:
...
3.  If B stays silent nodding, loses. Must verbalize their competence.
