...
## Mechanics
1.  Chaos: "Hey, the client says he doesn't like anything and that if we change the date, but it's just that then we don't arrive and what do we do!"
2.  Executive writes:
...
3.  Read aloud. If one of the 3 steps is missing, lose. If it is clear and directive, win.
