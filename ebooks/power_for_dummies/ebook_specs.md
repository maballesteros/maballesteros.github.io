# Especificaciones Editoriales y Pedagógicas (v2.0)

Este documento define el estándar de calidad para todas las entradas de *Power for Dummies*.

## 1. Estructura de la Entrada (Obligatoria)

### 1.1 Título y Objetivo
*   **Título**: `Habilidad + Beneficio` (≤70 caracteres).
...
## 2. Plantilla de Entrada (Para Copiar/Pegar)
...
*   **Formato**: Lista markdown.
    *   *Ejemplo*: `* [Día X: Nombre Entrada](../semana_XX/dia_XX.md)`
...
### Entrena esta teoría
* [Día X: Título Entrada](../semana_XX/dia_XX.md)
```
